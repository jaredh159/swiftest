public class Parser {
    ...
    -> String?
  {
    ...
    case Matcher.linkerDuplicateSymbolsLocationMatcher:
      outputType = OutputType.error
      return line.beautify(
        pattern: .linkerDuplicateSymbolsLocation, colored: colored, additionalLines: additionalLines
      )
    ...
    case Matcher.linkerUndefinedSymbolLocationMatcher:
      outputType = OutputType.error
      return line.beautify(
        pattern: .linkerUndefinedSymbolLocation, colored: colored, additionalLines: additionalLines)
