struct Matcher {
  ...
  static let paralleltestCaseFinishedMatcher = Regex(pattern: .parallelTestCasePassed)
  ...
  static let testCaseFinishedMatcher = Regex(pattern: .testCaseFinished)
  ...
  static let testSuiteFinishedMatcher = Regex(pattern: .testSuiteFinished)
