...
final class SwiftestPrettyTests: XCTestCase {
  ...
  func testTestCasesAddedToTestSuite_Isolate() throws {
  ...
  func testFailedTestCaseAddedToSuite_Isolate() throws {
    parseLine("Test Suite 'FooTests' started at 2021-09-27 08:46:18.280")
  ...
  // next, assert that the failure got captured by the suite
