...
final class SwiftestPrettyTests: XCTestCase {
  ...
  func testAggregateTarget() {
    ...
    XCTAssertEqual(
      formatted, "Aggregate target Be Aggro of project AggregateExample with configuration Debug")
  }
  ...
  func testLinking() {
      ...
      let formatted2 = noColoredFormatted(
  ...
  func testPackageGraphResolved() {
    ...
    // Package
    let package = noColoredFormatted(
